    ...
    <div className="container">
      <div className="row p-5 mt-5 ">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}}>   Company, Partnership and HUF Account </a><br />
          <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}}>   DP ID and ban details</a><br />
       ...
       <i class="fa fa-bar-chart" aria-hidden="true"></i>
        ...
        <i class="fa fa-circle" aria-hidden="true"></i>
          ...
          <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}}> National Pension Scheme</a><br />
        </div>
